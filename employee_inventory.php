    ...
    <div class="mainContent">
        ...
        <div class="categoryContainer">
            <div class="categoryCard" id="steelCard">
                <button class="categoryButton" onclick="toggleDropdown('steelDropdown')">Steel</button>
                <div id="steelDropdown" class="categoryDropdown">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<a href='employee-category.php?category=" . urlencode($row['category']) . "'>" . htmlspecialchars($row['category']) . "</a>";
                        }
                    } else {
            ...
            <div class="categoryCard" id="lumberCard">
                <button class="categoryButton" onclick="toggleDropdown('lumberDropdown')">Lumber</button>
